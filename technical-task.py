...
# could forego using the CSV module and directly operate on the data.
...
TEST_DATA_1 = """mon,tue,some_column1,wed,thu,fri,description
1,5,data,2,3,3,first_desc"""

TEST_DATA_2 = """mon-thu,fri,description,another_column2
2,3,second_desc,some_data"""

TEST_DATA_3 = """some_data,mon-tue,wed-thu,fri,description
,3,2,1,third_desc"""
